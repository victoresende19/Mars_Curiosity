...
if paginaSelecionada == 'Projeto':
    ...
    st.write("<p align='justify'> Após concluir a análise exploratória, dedicou-se a criação final desse relatório a fim de responder a primeira pergunta norteadora. Dessa maneira, esse relatório servirá como resumo e conclusão da análise exploratória feita, trazendo as informações gerais do possível clima meteorológico encontrado em Marte pelo rover Curiosity. Então, a seguir estão as informações que compõe o relatório climático de Marte de acordo com os dados da API com histórico coletado pelo rover Curiosity no período de 07 de Agosto de 2012 a 07 de Abril de 2021. <p align='justify'>", unsafe_allow_html=True) 
